...
public class AcoplamentoPaiFilhoTest {
    ...
    void gerenteComAcoplamentoGanha30Porcento() {
        GerenteComAcoplamento g = new GerenteComAcoplamento(10000.0, "ABC-1234");
    ...
    void gerenteSemAcoplamentoGanha30Porcento() {
        GerenteSemAcoplamento g = new GerenteSemAcoplamento(10000.0,"ABC-1234");
